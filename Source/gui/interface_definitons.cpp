...
namespace zlgui {
    ...
    void UIBase::loadFromAPVTS() {
        for (size_t i = 0; i < kColourNum; ++i) {
            ...
            auto col = juce::Colour(r, g, b, o);
            
            // Auto-migrate old default colors to the premium Sonnox Claro theme
            if (i == static_cast<size_t>(kBackgroundColour) && r == 20 && g == 16 && b == 9) {
                col = juce::Colour(static_cast<juce::uint8>(20), static_cast<juce::uint8>(24), static_cast<juce::uint8>(30), o);
            } else if (i == static_cast<size_t>(kTextColour) && r == 247 && g == 246 && b == 244) {
                col = juce::Colour(static_cast<juce::uint8>(225), static_cast<juce::uint8>(230), static_cast<juce::uint8>(235), o);
            } else if (i == static_cast<size_t>(kGlowColour) && r == 70 && g == 66 && b == 62) {
                col = juce::Colour(static_cast<juce::uint8>(50), static_cast<juce::uint8>(65), static_cast<juce::uint8>(80), o);
            } else if (i == static_cast<size_t>(kGridColour) && r == 112 && g == 112 && b == 112) {
                col = juce::Colour(static_cast<juce::uint8>(100), static_cast<juce::uint8>(115), static_cast<juce::uint8>(130), o);
            } else if (i == static_cast<size_t>(kPreColour) && r == 112 && g == 112 && b == 112) {
                col = juce::Colour(static_cast<juce::uint8>(110), static_cast<juce::uint8>(140), static_cast<juce::uint8>(180), o);
            } else if (i == static_cast<size_t>(kPostColour) && r == 112 && g == 112 && b == 112) {
                col = juce::Colour(static_cast<juce::uint8>(140), static_cast<juce::uint8>(175), static_cast<juce::uint8>(210), o);
            } else if (i == static_cast<size_t>(kSideColour) && r == 252 && g == 18 && b == 197) {
                col = juce::Colour(static_cast<juce::uint8>(120), static_cast<juce::uint8>(150), static_cast<juce::uint8>(190), o);
            }
            custom_colours_[i] = col;
        }
