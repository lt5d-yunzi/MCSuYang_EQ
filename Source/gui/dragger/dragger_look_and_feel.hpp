    ...
    public:
        ...
        void drawToggleButton(juce::Graphics& g, juce::ToggleButton& button,
            ...
            if (label_.length() > 0) {
                ...
                const float scale = label_.length() > 1 ? label_scale_ * 0.8f : label_scale_ * 0.9f;
                auto font = juce::Font(base_.getFontSize() * scale);
                font.setBold(true);
                g.setFont(font);
                ...
                g.drawText(label_, bound.translated(0.f, -0.5f), juce::Justification::centred);
            }
        }
