...
namespace zlstate {
    ...
    public:
        ...
        static constexpr auto kDefaultV = 1200.f;
    ...
    public:
        ...
        static constexpr auto kMaxV = 6000.f;
        static constexpr auto kDefaultV = 720.f;
        inline static const auto kRange = juce::NormalisableRange<float>(kMinV, kMaxV, 1.f);
    };
    ...
    inline constexpr std::array<ColourDefaultSetting, 9> kColourDefaults{
        ColourDefaultSetting{225, 230, 235, true, 1.f},     // text (premium off-white slate)
        ColourDefaultSetting{20, 24, 30, true, 1.f},        // background (Claro dark charcoal-blue)
        ColourDefaultSetting{0, 0, 0, true, 0.8f},          // shadow (softer black shadow)
        ColourDefaultSetting{50, 65, 80, true, 1.f},        // glow (cool slate-blue glow)
        ColourDefaultSetting{100, 115, 130, true, 0.12f},   // grid (subtle steel blue grid lines)
        ColourDefaultSetting{110, 140, 180, true, 0.15f},   // pre (steel blue spectrum)
        ColourDefaultSetting{140, 175, 210, true, 0.20f},   // post (light steel blue spectrum)
        ColourDefaultSetting{120, 150, 190, true, 0.15f},   // side (slate blue spectrum)
        ColourDefaultSetting{210, 90, 90, true, 0.6f},      // collision (muted soft red)
    };
