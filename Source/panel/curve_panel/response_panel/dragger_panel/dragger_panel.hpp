...
namespace zlpanel {
    class DraggerPanel final : public juce::Component,
                               ...
                               private zlgui::dragger::Dragger::Listener {
    public:
        ...
        zlgui::dragger::Dragger& getTargetDragger(const size_t band) {
            return target_draggers_[band];
        }
        ...
        bool isTargetHovering(const size_t) const {
            return false;
        }

        bool shouldTargetBeVisible(const size_t band) const {
            return is_dynamic_on_[band];
        }
    ...
    private:
        ...
        void draggerValueChanged(zlgui::dragger::Dragger* dragger) override;

        void dragStarted(zlgui::dragger::Dragger* dragger) override;

        void dragEnded(zlgui::dragger::Dragger* dragger) override;
    };
}
