...
namespace zlpanel {
    ...
    private:
        ...
        static constexpr auto kText =
            "Equalizer is Free and Open-source. Equalizer is licensed under AGPLv3. You can obtain the corresponding source code at https://github.com/ZL-Audio/ZLEqualizer.\n\n"
            "Copyright (c) 2026 [FERRY](http://www.kx2222.com)\n\n"
